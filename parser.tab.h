...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    L_PAREN = 281,                 /* L_PAREN  */
    R_PAREN = 282,                 /* R_PAREN  */
    L_SQBRACKET = 283,             /* L_SQBRACKET  */
    R_SQBRACKET = 284,             /* R_SQBRACKET  */
    L_CRLRBRACKET = 285,           /* L_CRLRBRACKET  */
    R_CRLRBRACKET = 286,           /* R_CRLRBRACKET  */
    AND = 287,                     /* AND  */
    OR = 288,                      /* OR  */
    NOT = 289,                     /* NOT  */
    ADDR = 290,                    /* ADDR  */
    ...
    COMMA = 292,                   /* COMMA  */
    KW_RETURN = 293,               /* KW_RETURN  */
    KW_PRINTF = 294,               /* KW_PRINTF  */
    KW_IF = 295,                   /* KW_IF  */
    KW_ELSE = 296,                 /* KW_ELSE  */
    KW_WHILE = 297,                /* KW_WHILE  */
    KW_FOR = 298,                  /* KW_FOR  */
    TYPE_INT = 299,                /* TYPE_INT  */
    TYPE_FLOAT = 300,              /* TYPE_FLOAT  */
    TYPE_DOUBLE = 301,             /* TYPE_DOUBLE  */
    TYPE_CHAR = 302,               /* TYPE_CHAR  */
    TYPE_BOOL = 303,               /* TYPE_BOOL  */
    TYPE_VOID = 304,               /* TYPE_VOID  */
    UMINUS = 305                   /* UMINUS  */
  };
